...
def MNIST(quantize=True):
    ...
    trololo = TROLOLO(image_size=28,
                      ...
                      attnproj_rank=0.07,
                      sequence_pyramid=[],
                      attn_rank_pyramid=[(0, 16),(1, 14), (2,8 ),(3,8)],
    ...
    trainer.training_loop(train_data=train_data,val_data=val_data,lr=2e-3*lr_scaling,lr_mid=1.0e-4*lr_scaling,lr_min=1e-6*lr_scaling,n_epochs=300,batch_size=batch_size,transfer=0,weight_decay=1e-2)
